...
public class Ts8_QuerydetailActivity extends AppCompatActivity {
    ...
    public void recorddetail(){
        ...
        RequestQueue rq = Volley.newRequestQueue(Ts8_QuerydetailActivity.this);
